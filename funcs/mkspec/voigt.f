...
c
c     DESCRIPTION
c     compute the relative flux value in a given pixel assuming a Voigt
c     function of the Lorenzian width of the line and a Gaussian
c     broadening function; no convolution is performed; see below notes
c
c
c------------------------------------------------------------------------------
c
