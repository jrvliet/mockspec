...
c 
      parameter ( NCPUs    = 32         ) ! anticipated number of processors
...
c 
      ...
      integer nrowreal, nMarkers, nhvarA, nsteprun
c 
      parameter ( ndim     = 3          ) ! # of spatial dimensions
      parameter ( mcell    = 10 000 000  ) ! # of refinement cells  10000000 (keep <65M cells for CL6csf1)  
...
c
      parameter ( npmax = 5 000 000 ) 
c     
      integer nstarmax 
      parameter ( nstarmax = 2 000 000 )	
c
