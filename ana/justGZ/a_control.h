...
c
c     ........ Kenza: stellar resampling parameters .......
c
      real*8 dt_resample
      real*8 t_lastresample
      real*8 t_lastresample_code
      common / RS01 / dt_resample
      common / RS02 / t_lastresample
      common / RS03 / t_lastresample_code
c
c
...
c
      ...
      parameter ( nsave  = 1000 ) ! STG: increased from 200 to 1000
c
...
c
      ...
      integer iOWork, iOErr, iODebug, iOut, iOIO
      parameter (iOut=6, iOWork=12, iOErr=13, iODebug=14, iOIO=15) 

      character*256 workfile, errorfile, processfile
      character*256 cflfile, runfile, timingfile
      character*256 debugfile, starfile, agnfile, iofile
